...
public class Application {
	...
	private static void trimSubMenu() {
		...
		do {
			...
			System.out.println("2. 메뉴 혹은 카테고리 코드로 갬색, 단 메뉴와 카테고리 둘 다 일치하는 경우도 검색하며, 검색조건이 없는 경우 전체 검색 ");
	...
	private static void chooseSubMenu() {
		...
		do {
			...
			System.out.println("1. 카테고리 상위 분류별 메뉴 보기 (식사, 음료, 디저트) ");
			System.out.println("9. 이전 메뉴로");
			System.out.println("번호를 입력하세요 : ");
	...
	private static SearchCriteria inputSupCategory() {
		Scanner sc = new Scanner(System.in);
		System.out.print("상위 분류를 입력해주세요 (식사, 음료, 디져트 ): ");
	...
	private static void ifSubMenu() {
		...
		do {
			...
			System.out.println("2. 메뉴 이름 혹은 카테고리 이름으로 검색하여 메뉴 목록 보여주기 ");
			System.out.println("9. 이전 메뉴로");
			System.out.println("번호를 입력하세요 : ");
	...
	private static int inputPrice() {
		Scanner sc = new Scanner(System.in);
		System.out.println("최대 금액을 입력하세요 : ");
